...
const formSchema = z.object({
  ...
  School: z.string({ required_error: "Please select a staff role" }),
  GradeLevel: z.string({ required_error: "Please select a staff role" }),
});
...
export default function EditForm({ buddy }: EditFormProps) {
  // 1. Define your form.
  ...
  async function onSubmit(values: z.infer<typeof formSchema>): Promise<void> {
    ...
    try {
      ...
      const response = await axios.put(`${api}/buddies/${id}`, values, {
